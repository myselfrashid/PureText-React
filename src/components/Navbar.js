...
export default function Navbar(props){
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="https://myselfrashid.github.io/PureText-React/">{props.Title}</a>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        <li className="nav-item">
          <a className="nav-link active" aria-current="page" href="https://myselfrashid.github.io/PureText-React/">Home</a>
        </li>
      </ul>
    </div>
